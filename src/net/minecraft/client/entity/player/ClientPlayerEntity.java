...
import by.algorithm.alpha.api.command.CommandDispatcher;
...
import by.algorithm.alpha.api.modules.impl.movement.AutoSprint;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Initclass.getInstance().playerOnServer) {
                Initclass.getInstance().playerOnServer = true;
            }

            Initclass.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Initclass.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Initclass.getInstance().getEventBus().post(eventMotion);
        ...
        Initclass.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Initclass.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        Initclass.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        Initclass.getInstance().getEventBus().post(sprintEvent);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Initclass.getInstance().getEventBus().post(noSlowEvent);
