...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Initclass.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Initclass.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Initclass.getInstance().getViaMCP().viaScreen.tick();
