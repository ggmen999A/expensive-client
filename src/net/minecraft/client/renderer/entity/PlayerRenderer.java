...
// Added null check for NoRender function
            ...
            try {
                ...
                if (Initclass.getInstance().getFunctionRegistry().getNoRender() != null

                        && Initclass.getInstance().getFunctionRegistry().getNoRender().element != null) {

                    hidePlayers = Initclass.getInstance().getFunctionRegistry().getNoRender().element.getValueByName("Игроки") != null

                            && Initclass.getInstance().getFunctionRegistry().getNoRender().element.getValueByName("Игроки").get();
            ...
            if (hidePlayers) {
                ...
                boolean customModelsEnabled = Initclass.getInstance().getFunctionRegistry().getCustomModels().isState();

                boolean applyToFriends = Initclass.getInstance().getFunctionRegistry().getCustomModels().friends.get();
