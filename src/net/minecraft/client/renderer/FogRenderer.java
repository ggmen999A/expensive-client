...
import by.algorithm.alpha.api.modules.impl.render.World;
...
public class FogRenderer
{
    ...
    public static void updateFogColor(ActiveRenderInfo activeRenderInfoIn, float partialTicks, ClientWorld worldIn, int renderDistanceChunks, float bossColorModifier)
    {
        ...
        World customFog = functionRegistry.getWorld();
        ...
        else
        {
            ...
            if (customFog.isState()){
                if (customFog.fogMode.is("Клиент")) {
                ...
                } else if (customFog.fogMode.is("Свой")){
                    int customColor = customFog.fogColor.get();
