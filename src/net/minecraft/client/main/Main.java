...
import by.algorithm.alpha.protection.NativeProtection;
...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        OptionSpec<String> optionspec10 = optionparser.accepts("username").withRequiredArg().defaultsTo("Solth_" + Util.milliTime() % 10L);
