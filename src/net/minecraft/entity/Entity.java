...
import by.algorithm.alpha.api.modules.impl.combat.Hitbox;
import by.algorithm.alpha.api.modules.impl.render.Trails;
import by.algorithm.alpha.system.events.EventStartRiding;
import by.algorithm.alpha.system.events.MovingEvent;
import by.algorithm.alpha.system.events.PostMoveEvent;
import by.algorithm.alpha.system.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Initclass.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Initclass.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Initclass.getInstance().getEventBus().post(new EventStartRiding(entityIn));
