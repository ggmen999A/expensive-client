...
import by.algorithm.alpha.system.events.EventDamageReceive;
...
public class EnderPearlEntity extends ProjectileItemEntity
{
    ...
    protected void onImpact(RayTraceResult result)
    {
       ...
       Initclass.getInstance().getEventBus().post(new EventDamageReceive(EventDamageReceive.DamageType.ENDER_PEARL));
