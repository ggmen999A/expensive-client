package by.algorithm.alpha.system.visuals.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import by.algorithm.alpha.Initclass;
import by.algorithm.alpha.system.visuals.ab.render.impl.AddedItemComponent;
import by.algorithm.alpha.system.visuals.ab.render.impl.AllItemComponent;
import by.algorithm.alpha.system.visuals.ab.render.impl.Component;
import by.algorithm.alpha.system.utils.client.IMinecraft;
import by.algorithm.alpha.system.utils.components.ButtonComponent;
import by.algorithm.alpha.system.utils.components.FieldComponent;
import by.algorithm.alpha.system.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Initclass.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
