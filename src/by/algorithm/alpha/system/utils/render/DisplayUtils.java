...
import by.algorithm.alpha.system.utils.shader.ShaderUtil;
...
public class DisplayUtils implements IMinecraft {
    ...
    public static void drawRoundedRectOutline(float x, float y, float width, float height, float radius, float outlineThickness, int color){
        ...
        for(int i = 0; i <= 90; i += 5) {
            float angle = (float)Math.toRadians((double)(270 + i));
            GL11.glVertex2f(x + width - radius + (float)Math.cos((double)angle) * radius, y + radius + (float)Math.sin((double)angle) * radius);
        }
        ...
        for(int i = 0; i <= 90; i += 5) {
            ...
            GL11.glVertex2f(x + width - radius + (float)Math.cos((double)angle) * radius, y + height - radius + (float)Math.sin((double)angle) * radius);
        }
        ...
        for(int i = 0; i <= 90; i += 5) {
            float angle = (float)Math.toRadians((double)(90 + i));
            GL11.glVertex2f(x + radius + (float)Math.cos((double)angle) * radius, y + height - radius + (float)Math.sin((double)angle) * radius);
        }
        ...
        for(int i = 0; i <= 90; i += 5) {
            float angle = (float)Math.toRadians((double)(180 + i));
            GL11.glVertex2f(x + radius + (float)Math.cos((double)angle) * radius, y + radius + (float)Math.sin((double)angle) * radius);
        }
