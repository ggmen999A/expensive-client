package by.algorithm.alpha.api.command.impl.feature;

import by.algorithm.alpha.api.command.*;
import com.google.common.eventbus.Subscribe;
import com.mojang.blaze3d.platform.GlStateManager;
import by.algorithm.alpha.Initclass;
import by.algorithm.alpha.api.command.impl.CommandException;
...
import by.algorithm.alpha.api.modules.impl.render.Arrows;
    ...
    private void onDisplay(EventDisplay e) {
        ...
        for (String name : waysMap.keySet()) {
            ...
            if (vec2f.equals(new Vector2f(Float.MAX_VALUE, Float.MAX_VALUE))) {
                ...
                Arrows.drawTriangle(-4, -1F, 4F, 7F, new Color(0, 0, 0, 32));
                Arrows.drawTriangle(-3F, 0F, 3F, 5F, new Color(color));
