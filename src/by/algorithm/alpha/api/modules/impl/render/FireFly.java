...
@ModuleAnnot(name = "Fire Fly", type = ModuleCategory.Render, description = "Летающие партиклы по миру")
public class FireFly extends Module {
    ...
    private final SliderSetting particleCount = new SliderSetting("Количество", 50.0f, 10.0f, 500.0f, 10.0f);

    private final CopyOnWriteArrayList<Particle> particles = new CopyOnWriteArrayList<>();

    public FireFly() {
        addSettings(setting, particleCount);
    }
    ...
    private void onDisplay(EventDisplay e) {
        ...
        // Добавляем новые частицы только если их меньше чем установлено в настройках
        if (particles.size() < particleCount.get().intValue()) {
