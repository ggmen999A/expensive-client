...
import by.algorithm.alpha.system.events.PlaceObsidianEvent;
...
@ModuleAnnot(name = "AutoExplosion", type = ModuleCategory.Combat, description = "Автоматически ставит кристалы")
