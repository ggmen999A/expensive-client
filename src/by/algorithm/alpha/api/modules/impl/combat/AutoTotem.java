...
import by.algorithm.alpha.system.events.EventSpawnEntity;
...
@ModuleAnnot(name = "AutoTotem", type = ModuleCategory.Combat, description = "Берет тотем в руку при низком здоровье")
